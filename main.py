...
def main(page: Page):
        ...
        tasks.controls.append(
            Container(
                ...
                content= CustomCheckBox(
                    'PINK',
                    label = 'Create some interesting content!'),
    ...
    first_page_contents = Container(
        content=Column(
            controls=[
                ...
                Container(height= 20),
                Text(
                    value='What\'s up, Fumbani',color='white' 
                ),
                Text(
                ...
                Container(height=20),
                Text(
                    value='TODAY\'S TASKS',color='white' 
                ),
                Stack(
                    controls=[
                        tasks,
    ...
    page_1 = Container(
        ...
        content=Column(
            controls=[
                Row(alignment='end',
                    controls=[
                    Container(border_radius=25, padding=padding.only(
                    top=13,left=13,
                ),
                height=50,
                width=50,
    ...
    page_2 = Row(alignment='end',
        ...
        Container(
            ...
            animate_scale=animation.Animation(40,curve='decelerate'),
            padding= padding.only(
                top=50,left=20,
                right=20, bottom=5
            ),
